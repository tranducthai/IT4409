...
export class ClassResourcesController {
    ...
    deleteFolder(
        ...
        return this.classResourcesService.removeFolder(id, req.user.sub, req.user.role);
    }
    ...
    async upload(
        ...
        const { url, fileName } = await this.storageService.upload('class-resources', file);
    ...
    deleteFile(
        ...
        return this.classResourcesService.removeFile(id, req.user.sub, req.user.role);
    }
}
