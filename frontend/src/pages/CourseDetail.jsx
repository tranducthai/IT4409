...
export default function CourseDetail() {
  ...
  return (
    <main className="mx-auto w-full max-w-7xl flex-grow px-4 py-10 md:px-8">
      ...
      {activeTab === 'progress' && (
        <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          <h2 className="text-lg font-bold text-slate-900">Theo doi tien do</h2>
          <p className="mt-1 text-sm text-slate-500">Tong quan qua trinh hoc tap</p>
          <div className="mt-4 grid gap-3 sm:grid-cols-3">
            <div className="rounded-xl border border-emerald-100 bg-emerald-50 p-3 text-center">
              <p className="text-xl font-bold text-emerald-700">{progress.completed}</p>
              <p className="text-xs text-emerald-700">Da hoan thanh</p>
            </div>
            <div className="rounded-xl border border-amber-100 bg-amber-50 p-3 text-center">
              <p className="text-xl font-bold text-amber-700">{progress.inProgress}</p>
              <p className="text-xs text-amber-700">Dang hoc</p>
            </div>
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-3 text-center">
              <p className="text-xl font-bold text-slate-700">{progress.todo}</p>
              <p className="text-xs text-slate-600">Chua hoc</p>
            </div>
          </div>
        </section>
      )}
      ...
      {activeTab === 'discussions' && (
        <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          <h2 className="text-lg font-bold text-slate-900">Thao luan</h2>
